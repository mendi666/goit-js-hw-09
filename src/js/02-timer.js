...
const options = {
    ...
    onClose(selectedDates) {
        if (selectedDates[0] <= new Date()) {window.alert('pick another date')
        startBtnRef.setAttribute('disabled', true)} else {
          ...
          minutesRef.innerHTML = minutes < 10 ? addLeadingZero(minutes) : minutes;
          secondsRef.innerHTML = seconds < 10 ? addLeadingZero(seconds) : seconds;
